    ...
    groupes: [
      ...
      },
      {
        ...
        points: [
          ...
          'La recherche d’un arrêt par son nom trouve les stations et les gares, comme Châtelet ou Nation, même sans accents, et ne mène plus à une commune lointaine du même nom.',
          ...
          'Sur la carte, le prix d’un projet se décale le long de son tracé au lieu de disparaître quand un autre prix le recouvre.',
          'Sur grand écran, la légende du budget passe à la ligne au lieu de glisser sous le compteur de voyageurs.',
          'Le tutoriel nomme le bouton qui termine le mandat par ce qui est écrit dessus, au lieu de parler d’un bouton rouge qui ne l’est pas sur tous les réseaux.',
        ],
      },
    ],
  },
