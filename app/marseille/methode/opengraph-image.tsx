...
export const alt = `Comment le simulateur calcule le budget, les coûts et les voyageurs du réseau ${VILLES.marseille.nom}`
export const size = TAILLE
export const contentType = 'image/png'

export default function Image() {
  return imageMethode(VILLES.marseille)
}
