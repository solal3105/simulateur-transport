...
export const FORMULE: Formule = {
  ...
  constantes: { lyon: 0.4302, toulouse: 0.2862, marseille: 0.39, nice: 0.3774, paris: 0.8276 },
  constantesMoteur: { lyon: 0.5376, toulouse: 0.2225, marseille: 0.3733, nice: 0.324, paris: 0.8659 },
  recalage: { lyon: -0.1074, toulouse: 0.0637, marseille: 0.0167, nice: 0.0534, paris: -0.0383 },
  ajustements: { paris: { metro: -0.7317 } },
