...
export const lyon: BudgetVille = {
  ...
  leviers: {
    ...
    explication:
      'Sytral a vendu 299,3 M€ hors taxes de billets et d’abonnements en 2025, sur tous ses réseaux, et son budget 2026 en prévoit 313,9 M€. Sans Rhônexpress, le réseau TCL en représente environ 282 M€, dont 60 % d’abonnements et 40 % de tickets. Les montants du jeu supposent environ 330 M€ par an : un point de hausse y rapporte 12 M€ par mandat sur les abonnements et 8 M€ sur les tickets, quand les recettes de 2025 donneraient 10 et 7. Les hausses de prix supposent que la fréquentation ne baisse pas. Le versement mobilité a rapporté 523,4 M€ en 2025, à 2 % de la masse salariale, le taux maximal dans la Métropole. La gratuité totale retire toute la billetterie : 1 925 M€ par mandat dans le jeu, environ 1 700 M€ avec les recettes de 2025. Les 11 à 25 ans paient 26 € par mois : nous estimons ce qu’ils rapportent à environ 50 M€ par an, soit 300 M€ par mandat, quand le jeu retire 240 M€ pour leur gratuité. Celle des 11-18 ans enfants d’abonnés vient d’une proposition de campagne chiffrée à 8 M€, sans dire sur quelle durée : le jeu la compte par an. Environ 170 000 personnes ont un tarif solidaire, gratuit ou à 11 € : les faire payer la moitié du plein tarif rapporterait au plus 53 M€ par an si aucune ne renonçait à son abonnement, soit 320 M€ par mandat ; le jeu en compte 240. Nous n’avons trouvé aucun chiffrage d’un métro toute la nuit : en 2019, Sytral consacrait 1,5 M€ par an à ses mesures pour la nuit, dont le métro jusqu’à 2 h, et le jeu compte 4 M€ par an. Une TVA à 5,5 % au lieu de 10 % laisserait au réseau 4,27 % de recettes en plus à prix inchangés, environ 12 M€ par an ; le jeu en compte 16.',
    sources: [
      {
        titre: 'Sytral Mobilités, compte financier 2025, délibération 26-028',
        url: `${SYTRAL}/371/26-028-delib-compte-financier-unique-pref.pdf`,
