...
export const VILLES: Record<IdVille, Ville> = {
  ...
  marseille: {
    ...
    lieux: [
      ...
      { nom: 'Les Pennes-Mirabeau', pos: [5.31, 43.41] },
  ...
  nice: {
    ...
    lieux: [
      ...
      { nom: 'Villefranche-sur-Mer', pos: [7.312, 43.704] },
      { nom: 'Beaulieu-sur-Mer', pos: [7.332, 43.707] },
  ...
  paris: {
    ...
    reseau: 'Île-de-France Mobilités',
    ...
    lieux: [
      ...
      { nom: 'Aubervilliers', pos: [2.383, 48.914] },
      { nom: 'Colombes', pos: [2.254, 48.922] },
      { nom: 'Rueil-Malmaison', pos: [2.19, 48.877] },
      { nom: 'Champigny-sur-Marne', pos: [2.515, 48.817] },
      { nom: 'Aulnay-sous-Bois', pos: [2.497, 48.938] },
      { nom: 'Bobigny', pos: [2.44, 48.908] },
      { nom: 'Ivry-sur-Seine', pos: [2.385, 48.813] },
      { nom: 'Saint-Maur-des-Fossés', pos: [2.487, 48.799] },
